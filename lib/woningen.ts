...
export const woningen: Woning[] = [
...

  {
    ...
    introductie: {
      ...
      en: 'There is a moment when the forest starts to work. Five minutes after arrival you let go of the motorway. Ten minutes later everyone speaks more quietly. Chalet Ann-Helena is built for that moment. Warm wood, high ceilings, a pond that has nowhere to be. This is what escaping feels like when you do it right.',
    },
    beschrijving: {
