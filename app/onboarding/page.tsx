...
function SectionHeading({ children }: { children: React.ReactNode }) {
  return (
    <p className="text-xs font-semibold uppercase tracking-widest text-moroww-label pt-2 pb-1 border-b border-moroww-brown/15">
      {children}
    </p>
  )
}
...
function StepIndicator({ current, total }: { current: number; total: number }) {
  ...
  return (
    <div className="mb-10">
      ...
      <p className="text-xs font-medium text-moroww-label uppercase tracking-widest text-center">
    ...
    <div className="min-h-screen px-6 py-16 md:py-24" style={{
      ...
      <div className="mx-auto max-w-xl">
        ...
        <div className="mb-12 text-center">
          <p className="text-xs font-medium uppercase tracking-widest text-moroww-label mb-4">
            Welkom bij moroww
          </p>
