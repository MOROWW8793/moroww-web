...
// Elk sectie-inner staat in <div className="mx-auto max-w-6xl"><div
// className="register-column">…</div></div>. De outer max-w-6xl beperkt
// hoe ver de sectie op zeer brede schermen uitrekt; de register-column
// (68ch) bepaalt de eigenlijke tekst- én hairline-breedte, en centreert
// zichzelf vanaf 1440px zodat de rechterhelft niet leeg oogt.
...
export default async function DeStandaardPage({
  ...
  return (
    <Register kant="eigenaar">
        ...
        <div className="mx-auto max-w-6xl">
          <div className="register-column">
            ...
            <p className="mt-mw-4 text-body-lg text-moroww-dark">
              Er is geen weging en er zijn geen uitzonderingen. Alle vier, of
              het huis komt er niet in.
            </p>
      ...
      {/* ── WAT WIJ TOEVOEGEN — zes tech-items ── */}
      <section className="w-full py-mw-8 px-6 md:px-12">
        <div className="mx-auto max-w-6xl">
          <div className="register-column">
...
// Twee curatie-citaten uit de pand-data — Ragna en Alexander over Nosso
// Logies (08.2026). Ontkaderd, met een hairline ertussen.
    ...
    <section className="w-full py-mw-8 px-6 md:px-12">
      <div className="mx-auto max-w-6xl">
        <div className="register-column">
          ...
          <div className="mt-mw-6 divide-y divide-moroww-rule border-t border-b border-moroww-rule">
            {geselecteerd.map((r) => {
